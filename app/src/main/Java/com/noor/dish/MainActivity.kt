...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Restore white status bar + black icons
    ...
    private fun setupRecycler(channels: List<Channel>) {
        ...
        recyclerView.adapter = ChannelAdapter(channels) { channel ->
            val intent = Intent(this, PlayerActivity::class.java).apply {
                putExtra("CHANNEL_STREAM_URL", channel.stream_url)
                putExtra("CHANNEL_LICENSE_URL", channel.license_url)
                putExtra("CHANNEL_TITLE", channel.title)
